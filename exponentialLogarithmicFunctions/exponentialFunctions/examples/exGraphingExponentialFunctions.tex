...
\begin{table}[]
    \centering
    \begin{tabular}{c|c}
         Domain and Range & The domain is \((-\infty,\infty).\) The range is \((0,\infty)\)  \\ \hline
         Intercepts & It has \(y\)-intercept \((0,1).\) Note that this is independent of \(b!\) \\ \hline
         Rising or falling & If \(b>1\) then the function is rising. If \(1>b>0\) then the function is falling. \\ \hline
