We will begin this section with some examples of exponential equations solved using the logarithm. Keep in mind that we will keep \(\log_b\left(x\right)\) in this form unless \(x\) is an integer power of \(b.\) In this case we can simplify since \(\log_b\left(x\right)\) would be an integer. For example, \(\log_5\left(25\right)\) should be simplified and written as \(2.\) Whereas, \(\log_5\left(2\right)\) is left as is.
