    ...
    \begin{expandable}{}{}
        \begin{solution}
            ...
            \begin{gather*}
                ...
                \frac{1}{2}u^2+2u-3=0
            \end{gather*}
            From the quadratic formula we see that \(u =  -2+\sqrt{10}, \ -2-\sqrt{10}\) then \(u^2=x.\)

            Thus we have \(\sqrt{x} = -2+\sqrt{10}\) and \(\sqrt{x} = -2-\sqrt{10}\)

            Since \(\sqrt{x} >0\) the only equation with solutions is \(\sqrt{x} = -2+\sqrt{10}>0.\)

            Squaring each side we get \(x = 14-4\sqrt{10}.\)
            
            The complete set of solutions to this equation is \(\{14-4\sqrt{10}\}.\)
        \end{solution}
    \end{expandable}
\end{question}