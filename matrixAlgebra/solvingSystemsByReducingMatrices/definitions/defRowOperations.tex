...
\begin{example}
   ...
   \[ \begin{cases}
    ...
    \begin{solution}
        ...
        We first go down the columns from left to right making the non leading entries zero. After this we go up the columns from right to left making the necessary entries zero.
